...
@Component({
    ...
    selector: 'kfthcl-nested-filter',
    templateUrl: './nested-filter.html',
    providers: [{
        provide: NG_VALUE_ACCESSOR,
        useExisting: forwardRef(() => NestedDropdown),
        multi: true,
    }],
    styleUrls: ['./nested-filter.scss'],
    // encapsulation: ViewEncapsulation.None,
    // changeDetection: ChangeDetectionStrategy.OnPush,
})
// eslint-disable-next-line @angular-eslint/component-class-suffix
export class NestedDropdown implements OnInit, OnDestroy, AfterViewInit, ControlValueAccessor {
