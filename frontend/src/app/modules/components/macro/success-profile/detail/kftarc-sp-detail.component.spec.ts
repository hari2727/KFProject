...
import { KfTarcSPDetailComponent } from './kftarc-sp-detail.component';
...
describe('KfTarcSPDetailComponent', () => {
    let component: KfTarcSPDetailComponent;
    let fixture: ComponentFixture<KfTarcSPDetailComponent>;
    ...
    beforeEach(async () => {
        ...
        KfThclSPSharedServiceMocks = {
            callViewAuditLog: jest.fn(),
        };

        await TestBed.configureTestingModule({
            declarations: [ KfTarcSPDetailComponent, KfTitlecasePipe, TranslatePipe],
            imports: [
    ...
    it('should update isDeselectAllOptionSelected to true', () => {
        component.deselectAllOptionSelected(true);
        expect(component.isDeselectAllOptionSelected).toBeTruthy();
    });

    it('should update isDeselectAllOptionSelected to false', () => {
        component.deselectAllOptionSelected(false);
        expect(component.isDeselectAllOptionSelected).toBeFalsy();
    });
    ...
    it('should initialize isDeselectAllOptionSelected to false', () => {
        expect(component.isDeselectAllOptionSelected).toBeFalsy();
    });

    it('should allow modification of isDeselectAllOptionSelected', () => {
        component.isDeselectAllOptionSelected = true;
        expect(component.isDeselectAllOptionSelected).toBeTruthy();
    });
});
