...
import { KfTarcSPViewOptions, KfTarcSuccessProfileDetailService } from '../kftarc-success-profile-detail.service';
...
@Component({
    selector: 'kftarc-market-data',
    templateUrl: './kftarc-market-data.component.html',
    styleUrls: ['./kftarc-market-data.component.scss'],
    providers: [DecimalPipe],
})
export class KfTarcMarketDataComponent implements OnDestroy, OnChanges {
